...
## Reviewer 2 validation extension

The experiment now addresses the four empirical concerns raised during review.
...
The exact full-run tables used for the reviewer response are committed under `results/reviewer2/`. See [`REVIEWER2_VALIDATION.md`](REVIEWER2_VALIDATION.md) for the protocol, values, interpretation, and remaining limitations.
